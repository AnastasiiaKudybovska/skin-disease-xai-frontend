      ...
      <Link href="/" sx={{ display: 'flex', alignItems: 'center', textDecoration: 'none' }}>
        ...
        {!isMobile ? (
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Typography component="a" href="/login"
              sx={{ mx: 1, color: 'var(--white-color)', textDecoration: 'none', cursor: 'pointer',
        ...
        <div className={`mobile-menu ${mobileMenuOpen ? 'open' : ''}`}>
          ...
          {navItems.map((item) => (
            <div key={item.path} className="mobile-menu-item">
              <Typography component="a" href={item.path}
                sx={{ width: '100%', display: 'block', padding: '8px 16px', color: 'var(--white-color)',
          ...
          <div className="mobile-menu-item">
            <Typography component="a" href="/login"
              sx={{ width: '100%', display: 'block', padding: '8px 16px', color: 'var(--white-color)', textDecoration: 'none', cursor: 'pointer',
                '&:hover': {
